...
{
    /// <inheritdoc />
    public partial class UpdateAuditoriaOperacion : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_auditoria_operacion", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ConfiguracionTributaria", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ConfiguracionTributaria_catalogo_actividad_economica_Activi~",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_auditoria_configuracion_ConfiguracionTributaria_Configuraci~",
                        column: x => x.ConfiguracionTributariaId,
                        principalSchema: "fiscalhost_db",
                        principalTable: "ConfiguracionTributaria",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_obligacion_tributaria_calculo_fiscal_CalculoFiscalCalculoId",
                        column: x => x.CalculoFiscalCalculoId,
                        principalSchema: "fiscalhost_db",
                        principalTable: "calculo_fiscal",
                        principalColumn: "calculo_id");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ConfiguracionTributaria_ActividadEconomicaCodigo",
                schema: "fiscalhost_db",
                table: "ConfiguracionTributaria",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_obligacion_tributaria_CalculoFiscalCalculoId",
                schema: "fiscalhost_db",
